...
public final class ApplicationIdentifiers {
    ...
    public static final Map<String, Integer> lengths = new HashMap<String, Integer>();
    public static final Map<String, String> names = new HashMap<String, String>();
    public static final Map<Integer, HashMap> values = new HashMap<Integer, HashMap>();
    ...
    static {
        ...
        HashMap<String, String> bValues = new HashMap<String, String>();
